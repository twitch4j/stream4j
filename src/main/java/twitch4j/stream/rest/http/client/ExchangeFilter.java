...
/**
 * A filter to manipulate "live" {@link HttpClientRequest} and {@link
 * HttpClientResponse}. Allows operations like setting and retrieving headers when
 * exchanging requests.
 *
...
public class ExchangeFilter {
	...
	/**
	 * An {@link twitch4j.stream.rest.http.client.ExchangeFilter} builder.
	 *
	 * @return a builder
	 */
	...
	/**
	 * A pre-made {@link twitch4j.stream.rest.http.client.ExchangeFilter} that will set a <code>Content-Type</code> header
	 * with the given value.
	 *
	 * @param contentType the value for the content type header
	 * @return a pre-made {@link twitch4j.stream.rest.http.client.ExchangeFilter}
	 */
	 ...
	 *
	 * @return a function that consumes a {@link HttpClientRequest}
	 */
	 ...
	 *
	 * @return a function that consumes a {@link HttpClientResponse}
	 */
	...
	/**
	 * A mutable builder for a {@link twitch4j.stream.rest.http.client.ExchangeFilter}.
	 */
	public static class Builder {
		 ...
		 *
		 * @param requestFilter a function that consumes a {@link HttpClientRequest}
		 * @return this builder
		 */
		 ...
		 *
		 * @param responseFilter a function that consumes a {@link HttpClientResponse}
		 * @return this builder
		 */
		...
		/**
		 * Build the {@link twitch4j.stream.rest.http.client.ExchangeFilter} instance.
		 *
